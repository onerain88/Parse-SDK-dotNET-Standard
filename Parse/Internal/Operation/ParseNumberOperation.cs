...
namespace ParseSDK.Internal.Operation {
    public class ParseNumberOperation : IParseOperation {
        ...
        internal ParseNumberOperation(object value) {
            this.value = value;
        }
        ...
        public IParseOperation MergeWithPrevious(IParseOperation previousOp) {
            ...
            if (previousOp is ParseNumberOperation incrementOp) {
                object otherAmount = incrementOp.value;
                return new ParseNumberOperation(Add(otherAmount, value));
            }
            return this;
        }
